...
func (c Cuboid) Tesselate() []Object {
	F1 := Quadrilateral{c.P1, c.P2, c.P3, c.P4, c.Material}.Tesselate()
	F2 := Quadrilateral{c.P2, c.P1, c.P5, c.P6, c.Material}.Tesselate()
	F3 := Quadrilateral{c.P3, c.P2, c.P6, c.P7, c.Material}.Tesselate()
	F4 := Quadrilateral{c.P4, c.P3, c.P7, c.P8, c.Material}.Tesselate()
	F5 := Quadrilateral{c.P1, c.P4, c.P8, c.P5, c.Material}.Tesselate()
	F6 := Quadrilateral{c.P6, c.P5, c.P8, c.P7, c.Material}.Tesselate()
...
func (r Quadrilateral) Tesselate() []Object {
	return []Object{
		NewTriangle(r.P1, r.P2, r.P4, r.Material),
		NewTriangle(r.P4, r.P2, r.P3, r.Material),
	}
}
